"""Kiem tra cac SO LIEU ma master plan (docs/17) trich dan, tren file THAT.

Guard P1 tinh than: khong go tay so vao doc. Moi con so trong docs/17 §A
...
# Layout file trong repo khong khop DEFAULT_* cua data_files.py (xem docs/17 §C5).
